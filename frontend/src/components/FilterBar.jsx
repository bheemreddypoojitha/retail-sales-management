  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={`flex items-center gap-2 px-3 py-1.5 text-s rounded-md transition-colors whitespace-nowrap ${
          selected.length > 0
          ...
          <div className="p-1">
            {options.map((option) => (
              ...
              >
                ...
                />
                <span className="ml-2 text-s text-gray-700 whitespace-nowrap pr-2">
                  {option}
                </span>
              </label>
            ))}
            {options.length === 0 && (
              <div className="px-2 py-1.5 text-s text-gray-400">Loading...</div>
            )}
          </div>
        </div>
      )}
        ...
        <div className="absolute z-10 mt-1 p-2 w-56 bg-white border border-gray-200 rounded-lg shadow-xl flex flex-col gap-2 right-0 sm:left-0">
          <div>
            ...
            <input
              ...
              className="w-full text-s border border-gray-300 rounded px-2 py-1 focus:ring-1 focus:ring-blue-500 outline-none"
            />
          </div>
          <div>
            <label className="block text-[10px] font-medium text-gray-500 mb-1">
        ...
        <div className="flex items-center ml-auto shrink-0">
          <div className="relative">
            <select
              ...
              className="appearance-none bg-gray-100 hover:bg-gray-200 text-gray-700 text-s py-1.5 pl-3 pr-7 rounded-md focus:outline-none cursor-pointer whitespace-nowrap"
            >
              <option value="date-newest">Sort by: Date (Newest)</option>
              <option value="quantity-high">Sort by: Quantity</option>
              <option value="customer-az">Sort by: Name (A-Z)</option>
            </select>
